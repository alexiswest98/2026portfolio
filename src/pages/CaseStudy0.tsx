...
function TechnicalDecision({
  ...
  return (
    <div className="tech-decision">
      ...
      <div className="tech-decision__block">
        <p className="tech-decision__label--blue">DECISION</p>
        <p className="tech-decision__decision-text">{decision}</p>
      </div>

      <div>
        <p className="tech-decision__label">IMPACT</p>
          ...
          <div className="cs0-design-callout">
            ...
            <div className="cs0-grid-3col">
              <div className="cs0-design-card">
                <div className="cs0-design-card__number">1</div>
                <h4 className="cs0-design-card__title">Content</h4>
                <p className="cs0-design-card__desc">What is explicitly being reported</p>
              </div>
              <div className="cs0-design-card">
                <div className="cs0-design-card__number">2</div>
                <h4 className="cs0-design-card__title">Structure</h4>
                <p className="cs0-design-card__desc">How the story is constructed and framed</p>
              </div>
              <div className="cs0-design-card">
                <div className="cs0-design-card__number">3</div>
                <h4 className="cs0-design-card__title">Context</h4>
